...
export const CloudRainIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M20 16.2A8.97 8.97 0 0 0 12 8a8.97 8.97 0 0 0-8 8.2"></path>
        <path d="M12 12v6"></path><path d="M8 12v6"></path><path d="M16 12v6"></path>
        <path d="M16 4a2.83 2.83 0 0 0-2-2.83"></path><path d="M8.2 6A2.83 2.83 0 0 0 6 4"></path>
    </svg>
);
